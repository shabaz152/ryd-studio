...
export const DEMO_REFERRAL_STATS: ReferralStats = {
  ...
  candidates: [
    ...
    },
    {
      ...
      email: 'rohan.d@ryd.edu',
      phone: '+91 98678 12345',
      specialty: 'Calculus & Engineering Mechanics',
      stage: 'rejected',
      dateReferred: '2026-09-09',
      referringTeacherId: 'tutor-shazz',
      referringTeacherName: 'Shazz (Lead Faculty)',
      payoutAmount: 0,
      payoutStatus: 'cancelled',
      rejectionDate: '2026-09-11',
      rejectionReason: 'Teaching demonstration did not meet AP Calculus pedagogy standards.',
      notes: 'Demonstration evaluated by Senior Academic Panel.'
    },
    {
      id: 'cand-shazz-prog',
      candidateName: 'Neha Kapoor',
      email: 'n.kapoor@ryd.edu',
      phone: '+91 98789 23456',
      specialty: 'Data Science & Applied Statistics',
      stage: 'interviewed',
      dateReferred: '2026-09-12',
      referringTeacherId: 'tutor-shazz',
      referringTeacherName: 'Shazz (Lead Faculty)',
      payoutAmount: 2500,
      payoutStatus: 'pending',
      notes: 'Completed stage 1 screening; director interview scheduled.'
    },
    {
      id: 'cand-2',
      ...
      payoutStatus: 'paid',
      payoutDate: '2026-09-13',
      notes: 'Demonstration and interview completed with distinction. Onboarded to Physics Faculty.'
    },
    {
      id: 'cand-alex-rej',
      candidateName: 'Marcus Vance',
      email: 'm.vance@ryd.edu',
      ...
      payoutAmount: 0,
      payoutStatus: 'cancelled',
      rejectionDate: '2026-09-12',
      rejectionReason: 'Schedule availability conflicts with required evening studio lab hours.',
      notes: 'Candidate unable to commit to minimum weekly studio schedule.'
    },
    {
      id: 'cand-alex-prog',
      candidateName: 'Dr. Sunita Rao',
      email: 's.rao@ryd.edu',
      phone: '+91 98901 45678',
      specialty: 'Physical Chemistry & Thermodynamics',
      stage: 'interviewed',
      ...
      payoutAmount: 2500,
      payoutStatus: 'pending',
      notes: 'Candidate submitted demo video; panel evaluation ongoing.'
    },
    {
      id: 'cand-priya-succ',
      candidateName: 'David K. Pillai',
      email: 'd.pillai@ryd.edu',
      phone: '+91 98112 56789',
      specialty: 'Machine Learning & Python Systems',
      stage: 'selected_successfully',
      dateReferred: '2026-09-07',
      referringTeacherId: 'tutor-priya',
      referringTeacherName: 'Priya Sundaram',
      payoutAmount: 2500,
      payoutStatus: 'paid',
      payoutDate: '2026-09-10',
      notes: 'Faculty review cleared. Onboarded as Python Track Instructor.'
    },
    {
      id: 'cand-3',
    ...
    {
      id: 'cand-priya-rej',
      candidateName: 'Kavita Verma',
      email: 'k.verma@ryd.edu',
      ...
      payoutStatus: 'cancelled',
      rejectionDate: '2026-09-12',
      rejectionReason: 'Academic credentials verification could not be validated.',
      notes: 'Incomplete transcript documentation provided.'
    }
  ],
  dayPayouts: [
    {
      ...
      teacherEmail: 'shazz.faculty@ryd.edu',
      candidateId: 'cand-1',
      candidateName: 'Dr. Rajiv Mehta',
      amountINR: 2500,
      date: '2026-09-12',
    ...
    },
    {
      ...
      date: '2026-09-13',
      status: 'paid',
      milestoneDescription: 'Referral Day Payout: Prof. Elena Rostova Selected Successfully',
    },
    {
      id: 'payout-4',
      ...
      candidateId: 'cand-priya-succ',
      candidateName: 'David K. Pillai',
      amountINR: 2500,
      date: '2026-09-10',
      status: 'paid',
      milestoneDescription: 'Referral Day Payout: David K. Pillai Selected Successfully',
    }
  ],
};
